...
class _StartPageWidgetState extends State<StartPageWidget>
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            44.0, 8.0, 44.0, 0.0),
                        child: Text(
                          'Thanks for joining! Access or create your account below, and get started on your journey to help save the planet.',
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.startPageController = null);
        },
        onSkip: () {
          return true;
        },
