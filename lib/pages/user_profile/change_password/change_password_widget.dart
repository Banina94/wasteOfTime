...
class _ChangePasswordWidgetState extends State<ChangePasswordWidget> {
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (_model.changePassword == true) {
                            context.pushNamed('successfulPasswordUpdate');
                          } else {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                        ...
                        button29jazmii,
                        _model.changePasswordController,
                      ),
                    ),
                ],
              ),
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.changePasswordController = null);
        },
        onSkip: () {
          return true;
        },
